...
import com.project.tanaka.repository.CategoryRepository;
import com.project.tanaka.service.dto.CategoryDTO;
import com.project.tanaka.service.mapper.CategoryMapper;
...
class CategoryResourceIT {
    ...
    public static Category createEntity(EntityManager em) {
        Category category = new Category().description(DEFAULT_DESCRIPTION).name(DEFAULT_NAME);
        return category;
    }
    ...
    public static Category createUpdatedEntity(EntityManager em) {
        Category category = new Category().description(UPDATED_DESCRIPTION).name(UPDATED_NAME);
        return category;
    }
    ...
    void putExistingCategory() throws Exception {
        ...
        updatedCategory.description(UPDATED_DESCRIPTION).name(UPDATED_NAME);
    ...
    void fullUpdateCategoryWithPatch() throws Exception {
        ...
        partialUpdatedCategory.description(UPDATED_DESCRIPTION).name(UPDATED_NAME);
